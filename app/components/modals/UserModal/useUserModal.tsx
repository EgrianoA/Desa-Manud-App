                    ...
                    <Col span={24} style={{
                        ...
                        >
                            <Card
                                ...
                                extra={userData?._id && <Button type='primary' danger onClick={() => onDelete(userData?._id)}>
                                    Hapus
                                </Button>}
                            >
                                <Form.Item
...
const useUserModal = () => {
    ...
    return {
        ...actions,
        render: () => <UserModal userData={userData} onClose={actions.close} visible={visible} loggedUserRole={loggedUserRole} />,
    };
}
